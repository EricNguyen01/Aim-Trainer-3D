...
namespace InfimaGames.LowPolyShooterPack.Legacy
{
	public class Projectile : MonoBehaviour
	{
        ...
        {
			public string WeaponThatSpawnedThisBullet;
			public bool HasHitTarget;
			public string TargetName;
			public Vector3 BulletFinalPosition;
        }
        ...
        private void Awake()
        {
			bulletData.WeaponThatSpawnedThisBullet = "n/a";
			bulletData.HasHitTarget = false;
			bulletData.TargetName = "n/a";
			bulletData.BulletFinalPosition = Vector3.zero;
        }
		...
		private void OnCollisionEnter(Collision collision)
		{
			...
			if (collision.transform.tag == "Blood" || collision.transform.CompareTag("Target"))
			{
		...
		public void SetWeaponThatSpawnedThisBullet(Weapon weapon)
        {
			bulletData.WeaponThatSpawnedThisBullet = weapon.GetWeaponName();
        }
