    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        public override void Fire(float spreadMultiplier = 1.0f)
        {
            ...
            for (var i = 0; i < shotCount; i++)
            {
                ...
                Quaternion rotation = Quaternion.LookRotation(playerCamera.forward * 1000.0f + spreadValue - muzzleSocket.localPosition);
                ...
                projectileScript.SetWeaponThatSpawnedThisBullet(this);
