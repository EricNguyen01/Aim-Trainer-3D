...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		private void Fire()
		{
			fireEvent.FirePosition = transform.position;
			fireEvent.IsAiming = holdingButtonAim;
			TelemetryLogger.Log(this, "Fire Successful At: ", fireEvent);
            ...
            {
				TelemetryLogger.Log(this, "Auto Reload On Empty");
		...
		public void OnTryPlayReload(InputAction.CallbackContext context)
		{
			...
			switch (context)
			{
				...
				case {phase: InputActionPhase.Performed}:
					if (equippedWeapon.HasAmmunition())
                    {
						TelemetryLogger.Log(this, "Manual Reload With Bullets# Left: ", equippedWeapon.GetAmmunitionCurrent());
                    }
					//Play Animation.
					PlayReloadAnimation();
					break;
		...
		public void OnUpdateTutorial(InputAction.CallbackContext context)
		{
			switch (context.phase)
			{
				//Performed.
				case InputActionPhase.Started:
					TelemetryLogger.Log(this, "Tab Pressed For Controls");
					break;
			}
			//Switch.
